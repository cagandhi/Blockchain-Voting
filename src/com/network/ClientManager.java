...
//	                System.out.println("vote choice : "+ voteChoice);
	...
	public Object decrypt(SealedObject sealedObject) throws IOException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeyException
	{
		SecretKeySpec sks = new SecretKeySpec("MyDifficultPassw".getBytes(), "AES");
	...
	public void close() {
		try {
			for(int i=0;i<blockList.size();i++) {
				System.out.println(decrypt(blockList.get(i))+Integer.toString(i)+"\\\\");
			}
			
			String fileName="/home/anshul/Desktop/blockchain_"+clientId;
